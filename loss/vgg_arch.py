...
class VGGFeatureExtractor(nn.Module):
    ...
    in the low feature and the type of vgg network. Note that the pretrained
    ...
    Args:
        ...
        use_input_norm (bool): If True, normalize the low image. Importantly,
            the low feature must in the range [0, 1]. Default: True.
